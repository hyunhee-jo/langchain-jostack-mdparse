...
class TestMarkdownExtractLoaderLoad:
    ...
    def test_load_json_split_sections(self, tmp_path: Path) -> None:
        ...
        with patch(
            "langchain_jostack_mdparse.document_loaders._extract", return_value=mock_result
        ):
            loader = MarkdownExtractLoader(md, format="json")
            docs = loader.load()
    ...
    def test_extract_kwargs_passed(self, tmp_path: Path) -> None:
        ...
        with patch("langchain_jostack_mdparse.document_loaders._extract") as mock:
    ...
    def test_multiple_files(self, tmp_path: Path) -> None:
        ...
        with patch(
            "langchain_jostack_mdparse.document_loaders._extract",
